...
<case codeversion="1.0" codename="Mahyco" xml:lang="en">
  <arcane>
    <title>CAS_bitriplepoint_minmod</title>
  ...
  <environment>
   ...
   <remap name="RemapADI">
    ...
    <projection-pente-borne>false</projection-pente-borne>
    <projection-simple-pente>false</projection-simple-pente>
    ...
    <projection-limiteur-id>2</projection-limiteur-id>
    <projection-limiteur-pure-id>2</projection-limiteur-pure-id>
   </remap>
