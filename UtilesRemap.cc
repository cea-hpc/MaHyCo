...
// KOKKOS_INLINE_FUNCTION
// double computeygyd(double y0, double yplus, double ymoins, double h0, double
// grady, int type)
// {
//   // retourne {{yg, yd}}
//   double yd, yg;
...
template <size_t d>
KOKKOS_INLINE_FUNCTION RealArray1D<d> computeAndLimitGradPhi(
...
template <size_t d>
KOKKOS_INLINE_FUNCTION RealArray1D<d> computeIntersectionPP(
...
template <size_t d>
KOKKOS_INLINE_FUNCTION RealArray1D<d> computeIntersectionPPPure(
    RealArray1D<d> gradphi, RealArray1D<d> phi, RealArray1D<d> phiplus,
    RealArray1D<d> phimoins, double h0, double hplus, double hmoins,
    double face_normal_velocity, double deltat_n, int type, int cell,
    double flux_threhold) {
...
template <size_t d>
KOKKOS_INLINE_FUNCTION RealArray1D<d> computeUpwindFaceQuantities(
...
template <size_t d>
KOKKOS_INLINE_FUNCTION RealArray1D<d> computeRemapFlux(
