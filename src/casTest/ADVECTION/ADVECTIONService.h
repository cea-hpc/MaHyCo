...
public:
  ...
  virtual void initVarMono(Integer dim, Real3 densite_initiale, Real3 pression_initiale, Real3x3 vitesse_initiale );
  virtual void initMat(Integer dim);
  virtual void initVar(Integer dim, Real3 densite_initiale, Real3 pression_initiale, Real3x3 vitesse_initiale );
