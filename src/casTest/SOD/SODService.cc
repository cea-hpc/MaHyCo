...
void SODService::initVarMono(Integer dim, Real3 densite_initiale, Real3 pression_initiale, 
...
void SODService::initVar(Integer dim, Real3 densite_initiale, Real3 pression_initiale, 
                                   Real3x3 vitesse_initiale)  {
