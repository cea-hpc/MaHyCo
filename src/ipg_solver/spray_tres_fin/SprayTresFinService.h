...
#ifndef SPRAYTRESFINSERVICE_H
#define SPRAYTRESFINSERVICE_H
...
#include "ipg_solver/spray_tres_fin/SprayTresFin_axl.h"
...
class SprayTresFinService
: public ArcaneSprayTresFinObject
{
public:

  /** Constructeur de la classe */
  SprayTresFinService(const ServiceBuildInfo & sbi)
    : ArcaneSprayTresFinObject(sbi) {}

  /** Destructeur de la classe */
  virtual ~SprayTresFinService() {};
