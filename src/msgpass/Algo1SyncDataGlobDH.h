#ifndef MSG_PASS_ALGO1_SYNC_DATA_GLOB_DH_H
#define MSG_PASS_ALGO1_SYNC_DATA_GLOB_DH_H
...
/*---------------------------------------------------------------------------*/
class Algo1SyncDataGlobDH : public IAlgo1SyncData {
 public:
  /*!
   * \brief Persistent information which don't depend on the variables
   */
  class PersistentInfo {
    friend class Algo1SyncDataGlobDH;
   public:
 ...
 public:
  Algo1SyncDataGlobDH(MeshVariableSynchronizerList& vars,
      Ref<RunQueue> ref_queue,
      PersistentInfo& pi);

  virtual ~Algo1SyncDataGlobDH();
