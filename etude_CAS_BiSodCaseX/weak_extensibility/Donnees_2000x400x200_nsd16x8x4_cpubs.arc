...
<case codeversion="1.0" codename="Mahyco" xml:lang="en">
  ...
  <arcane-post-processing>
    <output-period>1000000</output-period>
    <output>
  ...
  <mesh nb-ghostlayer="2" ghostlayer-builder-version="3">
    <meshgenerator>
     <cartesian>
       <nsd>16 8 4</nsd> 
       <origine>-1.5 0.0 0.0</origine>
       <lx nx='2000' prx='1.0'>4.0</lx>
       <ly ny='400'  pry='1.0'>0.4</ly>
       <lz nz='200'  prz='1.0'>0.2</lz>
     </cartesian>
  ...
  <acc-env-default>
    ...
    <var-sync-version>bulksync_std</var-sync-version>
  </acc-env-default>
